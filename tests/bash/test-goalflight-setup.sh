...
install_alias_dry="$(bash "$REPO_ROOT/install.sh" --no-deps --cursor --addons '')"
...
cursor_install_out="$(bash "$REPO_ROOT/install.sh" --no-deps cursor "$CURSOR_ONE_SHOT" --addons '' 2>&1)"
...
install_opencode_alias_dry="$(bash "$REPO_ROOT/install.sh" --no-deps --opencode --addons '')"
...
opencode_install_out="$(bash "$REPO_ROOT/install.sh" --no-deps opencode "$OPENCODE_ONE_SHOT" --addons '' 2>&1)"
