...
# Source: examples/echo-agent.py
# Local changes: none (vendored verbatim as a smoke-test fixture)
"""
...
合规测试:
  bash tests/fixtures/acp_echo_agent.py python examples/echo-agent.py
"""
