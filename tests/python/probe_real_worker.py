...
Usage:
  ~/.goal-flight/venvs/acp-0.10/bin/python tests/python/probe_real_worker.py codex-acp
  ~/.goal-flight/venvs/acp-0.10/bin/python tests/python/probe_real_worker.py grok agent stdio
  ~/.goal-flight/venvs/acp-0.10/bin/python tests/python/probe_real_worker.py \\
